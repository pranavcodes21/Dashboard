...
with st.sidebar:
    ...
    if modify_fixed:
        ...
        salary = st.number_input("Salary", value=FIXED_COSTS['Salary (14 staff)'], step=5000)
        ...
        FIXED_COSTS['Salary (14 staff)'] = salary
...
with col2:
    ...
    - **Salary (14 staff)**: ₹{FIXED_COSTS['Salary (14 staff)']:,}
